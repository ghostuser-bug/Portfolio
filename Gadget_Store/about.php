    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-6 mb-4 team-member">
                <img src="gambar adam.jpg" alt="NURUL YASMIN" class="img-fluid rounded-circle">
                <h4 class="mt-3">NUR ADAM</h4>
                <p>CEO & Founder</p>
            </div>
            <div class="col-lg-3 col-md-4 col-6 mb-4 team-member">
                <img src="gambar yasmin.jpg" alt="NUR ADAM" class="img-fluid rounded-circle">
                <h4 class="mt-3">NURUL YASMIN</h4>
                <p>Head of Marketing</p>
            </div>
            <div class="col-lg-3 col-md-4 col-6 mb-4 team-member">
                <img src="gambar el.jpg" alt="MAISARAH ELISA" class="img-fluid rounded-circle">
                <h4 class="mt-3">MAISARAH ELISA</h4>
                <p>Product Manager</p>
            </div>
            <div class="col-lg-3 col-md-4 col-6 mb-4 team-member">
                <img src="gambar aiman.jpg" alt="NYR AIMAN" class="img-fluid rounded-circle">
